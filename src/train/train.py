...
def train(output_model_path: str = os.path.join(cur_dir, 'output_models'), vocab_path: str = None):
    os.makedirs(output_model_path, exist_ok=True)
    siamese_net = ImageSiamese()
    text_encoder = TextEncoder(vocab_path)
    ...
    train_data_loader = get_data_loader(root=os.path.join(cur_dir, '../../flickr30k_images'))
    #test_data_loader = get_data_loader(root=os.path.join(cur_dir, '../../flickr30k_images'))
